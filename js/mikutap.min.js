...
var MainManager = function() {
        ...
        function o() {
            if (P.update(), 1 == g && 0 > --L && r(), v && 1 == g) {
                ...
                if (l * s < a) {
                    ...
                    if (h += e - l, 0 <= (l = e) * s - a) for (e = Math.random(), a = 1, 192 <= h ? h = 0 : 128 <= h ? (.7 > e && (a = 2), .5 > e && (a = 3)) : 64 <= h ? (.35 > e && (a = 2), .2 > e && (a = 3), .02 > e && (a = 0)) : 32 <= h ? (.35 > e && (a = 2), .24 > e && (a = 0)) : 0 <= h && .4 > e && (a = 0), e = 0; e < a; e++) d = c[f], 32 <= ++f && (f = 0, aidn.util.shuffleArray(c)), k.changeId(d, 0, !0)
                }
            }
                ...
                this.resize = function() {
                    if (C) {
                        var a = 0,
                            ...
                            n = I;
                        M < w && (e = I, n = y);
                        for (var t = w / e, i = M / n, o = 0; o < n; o++) for (var r = 0; r < e; r++) {
                            var l;
        ...
        i(), aidn.util.webaudio ? ($("#ng").css("display", "none"), $(".ok").css("display", "block"), m && $("#scene_main .attention").html("轻触或滑动!"), u || $("#scene_top .attention").text("※ 请打开声音！")) : ($("#ng").css("display", "block"), $(".ok").css("display", "none"), u || $("#ng .atten").html("抱歉，</br>你的浏览器不支此页面")), PIXI.utils._saidHello = !0, aidn.window.resize(a)
    },
